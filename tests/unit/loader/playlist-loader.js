...
http://proxy-62.dailymotion.com/sec(3ae40f708f79ca9471f52b86da76a3a8)/video/107/282/158282701_mp4_h264_aac_hq.m3u8#cell=core`;
    ...
    expect(result['com.dailymotion.sessiondata.test']['DATA-ID']).to.equal('com.dailymotion.sessiondata.test');
    expect(result['com.dailymotion.sessiondata.test']['VALUE']).to.equal('some data');
  });
...
http://proxy-62.dailymotion.com/sec(3ae40f708f79ca9471f52b86da76a3a8)/video/107/282/158282701_mp4_h264_aac_hq.m3u8#cell=core`;
    ...
    expect(result['com.dailymotion.sessiondata.test2']['DATA-ID']).to.equal('com.dailymotion.sessiondata.test2');
    expect(result['com.dailymotion.sessiondata.test2']['VALUE']).to.equal('different data');

    expect(result['com.dailymotion.sessiondata.test3']['DATA-ID']).to.equal('com.dailymotion.sessiondata.test3');
    expect(result['com.dailymotion.sessiondata.test3']['VALUE']).to.equal('different data');
    expect(result['com.dailymotion.sessiondata.test3']['URI']).to.equal('http://www.dailymotion.com/');
  });

  it('parses manifest with no EXT-X-SESSION-DATA', function () {
    let manifest = `#EXTM3U
#EXT-X-STREAM-INF:PROGRAM-ID=1,BANDWIDTH=836280,CODECS="mp4a.40.2,avc1.64001f",RESOLUTION=848x360,NAME="480"
http://proxy-62.dailymotion.com/sec(3ae40f708f79ca9471f52b86da76a3a8)/video/107/282/158282701_mp4_h264_aac_hq.m3u8#cell=core`;
